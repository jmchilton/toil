...
class AWSProvisioner(AbstractProvisioner):
    ...
    def launchCluster(self, leaderNodeType, leaderSpotBid, nodeTypes, preemptableNodeTypes, keyName, 
            clusterName, numWorkers=0, numPreemptableWorkers=0, spotBids=None, userTags=None, zone=None, vpcSubnet=None):
        if userTags is None:
            userTags = {}
        ...
        if numWorkers > 0 or numPreemptableWorkers > 0:
            ...
            logger.info('Added %d workers with %d workers requested', workersCreated, numWorkers + numPreemptableWorkers)
    ...
    def addNodes(self, numNodes, preemptable, nodeType):
        instanceType = ec2_instance_types[nodeType]
